...
public class PeopleThread{
	...
	/*
		Does : runs an iteration of the engine, i.e all agents are called once.
		Returns -1 if an error occurred, 1 if all agents are dead.
		Otherwise, returns 0
	 */
	...
	/*
		Does : returns a list of reference to unemployed agents
	 */
	...
	/*
		Does : returns the amount of land possessed by agents based on their work
	 */
	public List<Integer> getLandByWork(){
		return this.landByWork;
	}
	/*
		Does : resets the amount of land possessed by agents based on their work
	 */
	...
	/*
		Does : returns the number of agents where isAdult() == False
	 */
	...
	/*
		Does : returns the PeopleThread as formatted string
	 */
