...
public class Society{
    ...
    /*
        Input : writer (DatabaseWriter) : a reference to the database connection handler
                write (boolean) : indicates if it should force a database write
        Does : runs the society for one iteration.
        Returns -1 if no agents left in the society, otherwise 0.
     */
    ...
    /*
        Does : returns the society as a formatted string
     */
