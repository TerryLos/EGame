...
public class WoodCutter extends Work {
    ...
    /*
    Does : returns woodcutter formatted as a string
    */
    @Override
    ...
    /*
		Does : returns the woodcutter yield
	 */
    @Override
    ...
    /*
        Does : computes the scarcity of wood on the land possessed
     */
...
class Wood {
    ...
    /*
        Does : updates the timer linked to the amount of wood cut.
        Returns true if the wood has finished growing, false otherwise.
     */
